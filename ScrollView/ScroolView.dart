...
class ScroolView extends StatefulWidget {
  const ScroolView({Key? key}) : super(key: key);

  @override
  State<ScroolView> createState() => _ScroolView();
}

class _ScroolView extends State<ScroolView> {
  String? answer = "";
  String? answer1 = "";
  String? answer2 = "";
  String? answer3 = "";
